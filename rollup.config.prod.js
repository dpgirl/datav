...
const outUmdPath = path.resolve(__dirname, './dist/datav.min.js')
const outEsPath = path.resolve(__dirname, './dist/datav.es.min.js')
const outCjsPath = path.resolve(__dirname, './dist/datav.cjs.min.js')
